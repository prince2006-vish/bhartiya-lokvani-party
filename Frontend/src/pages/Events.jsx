    ...
    <section className="public-events">
      <div className="events-container">
        <div className="public-events-heading">
          ...
          <p>हमारे आगामी कार्यक्रमों और जन संवाद की जानकारी यहां देखें।</p>
        </div>

        {loading ? (
          <div className="events-loading">कार्यक्रम लोड हो रहे हैं...</div>
        ) : events.length === 0 ? (
          ...
          <div className="public-events-grid">
            {events.map((event) => (
              <article className="public-event-card" key={event._id}>
                {event.imageUrl && (
